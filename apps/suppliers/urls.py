...
urlpatterns = [
    ...
    path('farmers/import/errors/<int:pk>/', views.FarmerImportErrorsView.as_view(), name='farmer_import_errors'),
    ...
    path('farms/import/history/', views.FarmImportHistoryView.as_view(), name='farm_import_history'),
