...
urlpatterns = [
    ...
    path('ops/tenants/<int:pk>/suspend/', views.ops_tenant_suspend, name='ops_tenant_suspend'),
    path('ops/tenants/<int:pk>/delete/', views.ops_tenant_delete, name='ops_tenant_delete'),
    ...
    path('ops/deforestation/', views.ops_deforestation, name='ops_deforestation'),
